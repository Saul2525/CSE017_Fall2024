...
public class Movie extends Media {
    ...
    */
    ...
    /**
     * @return A formated String containing type, super.fileToString(), which contains title, category, year, and size, director, and the revenue.
    */
    @Override public String fileToString() {
        String type = "Movie";
        return String.format("%s,%s,%s,%s", type, super.fileToString(), director, revenue);
    }
