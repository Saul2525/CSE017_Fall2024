...
*/
public abstract class Media implements Archivable, Comparable<Media> {
    ...
    */
    ...
    /**
     * Compares two media objects titles.
    */
    ...
    /**
     * Checks if the media object's year of release is below a certain year.
    */
    @Override public boolean isArchivable() {
        return (this.getYear() < 1975);
    }

    /**
     * Compares two media objects titles. Return true if they are equal. False otherwise.
    */
    public boolean equals(Object o) {
        ...
        Media tempMedia = (Media) o;
        return this.title.equals(tempMedia.getTitle());
    }
}